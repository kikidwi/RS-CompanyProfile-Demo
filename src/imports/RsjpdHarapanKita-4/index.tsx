import svgPaths from "./svg-uwdpv990rp";
...
import imgImageDrDrIwanDakotaSpJpKMarsFaccFesc from "./715a6bcda173dcc034fac974a04c73bfeca37fa8.png";
import imgImageDrMuhadiSpPdKkvMEpid from "./73b89350801d3f3cc185b30f70ad95d847da1542.png";
import imgImageDrDrDickyAHanafySpJpSubspArKSubspKlK from "./a07d052797832804449d0746343c51e53f2f9d8f.png";
import imgImageTriHartonoRiantoSeMBusAkCaCpmaAseanCpaQhia from "./882a1cc3567b73cff8da2b6b7a75778885ae0edf.png";
import imgImageDrDrgMayaMarindaMontainMKes from "./9513d847cc2cf08d1c372e27917fa2f8f3b963eb.png";
import imgImageDrHaruddinSStMKesQrmaQhia from "./68c75b5d0b2ffd264d5cc9275661acc7b76e11e5.png";
...
function Container11() {
  return (
    <div className="relative self-stretch shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <p className="[word-break:break-word] font-['__Karla_4e868f:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#7b7b7b] text-[16px] whitespace-nowrap">Tentang Kami</p>
      </div>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="absolute content-stretch flex h-[56px] items-start left-0 p-[16px] rounded-tl-[6px] rounded-tr-[6px] top-0" data-name="Container">
      <Container11 />
    </div>
  );
}
...
function Container12() {
  return (
    <div className="absolute content-stretch flex h-[56px] items-start left-[132.27px] p-[16px] rounded-tl-[6px] rounded-tr-[6px] top-0" data-name="Container">
      <Container13 />
    </div>
  );
}
...
function Container15() {
  return (
    <div className="relative self-stretch shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <p className="[word-break:break-word] font-['__Karla_4e868f:Semi_Bold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#3b9ca5] text-[16px] whitespace-nowrap">Jajaran Direksi</p>
      </div>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="absolute bg-[rgba(59,156,165,0.2)] content-stretch flex h-[57px] items-start left-[244.95px] pb-[17px] pt-[16px] px-[16px] rounded-tl-[6px] rounded-tr-[6px] top-0" data-name="Container">
...
function Container16() {
  return (
    <div className="absolute content-stretch flex h-[56px] items-start left-[390.2px] p-[16px] rounded-tl-[6px] rounded-tr-[6px] top-0" data-name="Container">
      <Container17 />
    </div>
  );
}
...
function Container18() {
  return (
    <div className="absolute content-stretch flex h-[56px] items-start left-[548.22px] p-[16px] rounded-tl-[6px] rounded-tr-[6px] top-0" data-name="Container">
      <Container19 />
    </div>
  );
}
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[56px] items-start left-[724.2px] p-[16px] rounded-tl-[6px] rounded-tr-[6px] top-0" data-name="Container">
      <Container21 />
    </div>
  );
}
...
function ImageDrDrIwanDakotaSpJpKMarsFaccFesc() {
  return (
    <div className="h-[409.359px] relative rounded-[10px] shrink-0 w-[289.5px]" data-name="Image (Dr. dr. Iwan Dakota, Sp.JP(K), MARS, FACC, FESC)">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgImageDrDrIwanDakotaSpJpKMarsFaccFesc} />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0" data-name="Paragraph:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[8px] relative size-full">
        <p className="[word-break:break-word] font-['__Karla_4e868f:Semi_Bold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#3b9ca5] text-[16px] text-center w-[290px]">Dr. dr. Iwan Dakota, Sp.JP(K), MARS, FACC, FESC</p>
      </div>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 top-0 w-[289.5px]" data-name="Container">
      <ImageDrDrIwanDakotaSpJpKMarsFaccFesc />
      <ParagraphMargin />
      <p className="[word-break:break-word] font-['__Karla_4e868f:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#3b9ca5] text-[14px] text-center w-[290px]">Direktur Utama Rumah Sakit Jantung dan Pembuluh Darah Harapan Kita</p>
    </div>
  );
}

function ImageDrMuhadiSpPdKkvMEpid() {
  return (
    <div className="h-[409.359px] relative rounded-[10px] shrink-0 w-[289.5px]" data-name="Image (dr. Muhadi, Sp. PD, KKV, M.Epid)">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgImageDrMuhadiSpPdKkvMEpid} />
    </div>
  );
}
...
function ParagraphMargin1() {
  return (
    <div className="relative shrink-0" data-name="Paragraph:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[8px] relative size-full">
        <p className="[word-break:break-word] font-['__Karla_4e868f:Semi_Bold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#3b9ca5] text-[16px] text-center whitespace-nowrap">dr. Muhadi, Sp. PD, KKV, M.Epid</p>
      </div>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute content-stretch flex flex-col h-[507.359px] items-center left-[297.5px] top-0 w-[289.5px]" data-name="Container">
      <ImageDrMuhadiSpPdKkvMEpid />
      <ParagraphMargin1 />
      <p className="[word-break:break-word] font-['__Karla_4e868f:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#3b9ca5] text-[14px] text-center whitespace-nowrap">Direktur Medik dan Keperawatan</p>
    </div>
  );
}

function ImageDrDrDickyAHanafySpJpSubspArKSubspKlK() {
  return (
    <div className="h-[409.359px] relative rounded-[10px] shrink-0 w-[289.5px]" data-name="Image (Dr. dr. Dicky A Hanafy, Sp.Jp, Subsp Ar(K), Subsp Kl(K))">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgImageDrDrDickyAHanafySpJpSubspArKSubspKlK} />
    </div>
  );
}
...
function ParagraphMargin2() {
  return (
    <div className="relative shrink-0" data-name="Paragraph:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[8px] relative size-full">
        <p className="[word-break:break-word] font-['__Karla_4e868f:Semi_Bold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#3b9ca5] text-[16px] text-center w-[290px]">Dr. dr. Dicky A Hanafy, Sp.Jp, Subsp Ar(K), Subsp Kl(K)</p>
      </div>
    </div>
  );
}
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col h-[507.359px] items-center left-[595px] top-0 w-[289.5px]" data-name="Container">
      <ImageDrDrDickyAHanafySpJpSubspArKSubspKlK />
      <ParagraphMargin2 />
      <p className="[word-break:break-word] font-['__Karla_4e868f:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#3b9ca5] text-[14px] text-center whitespace-nowrap">Direktur SDM, Pendidikan dan Penelitian</p>
    </div>
  );
}

function ImageTriHartonoRiantoSeMBusAkCaCpmaAseanCpaQhia() {
  return (
    <div className="h-[409.359px] relative rounded-[10px] shrink-0 w-[289.5px]" data-name="Image (Tri Hartono Rianto, SE, MBus, Ak, CA, CPMA, ASEAN CPA, QHIA)">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgImageTriHartonoRiantoSeMBusAkCaCpmaAseanCpaQhia} />
    </div>
  );
}
...
function ParagraphMargin3() {
  return (
    <div className="relative shrink-0" data-name="Paragraph:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[8px] relative size-full">
        <p className="[word-break:break-word] font-['__Karla_4e868f:Semi_Bold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#3b9ca5] text-[16px] text-center w-[290px]">Tri Hartono Rianto, SE, MBus, Ak, CA, CPMA, ASEAN CPA, QHIA</p>
      </div>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="absolute content-stretch flex flex-col h-[507.359px] items-center left-[892.5px] top-0 w-[289.5px]" data-name="Container">
      <ImageTriHartonoRiantoSeMBusAkCaCpmaAseanCpaQhia />
      <ParagraphMargin3 />
      <p className="[word-break:break-word] font-['__Karla_4e868f:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#3b9ca5] text-[14px] text-center whitespace-nowrap">Direktur Keuangan dan BMN</p>
    </div>
  );
}

function ImageDrDrgMayaMarindaMontainMKes() {
  return (
    <div className="h-[409.359px] relative rounded-[10px] shrink-0 w-[289.5px]" data-name="Image (Dr. drg. Maya Marinda Montain, M.kes)">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgImageDrDrgMayaMarindaMontainMKes} />
    </div>
  );
}
...
function ParagraphMargin4() {
  return (
    <div className="relative shrink-0" data-name="Paragraph:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[8px] relative size-full">
        <p className="[word-break:break-word] font-['__Karla_4e868f:Semi_Bold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#3b9ca5] text-[16px] text-center whitespace-nowrap">Dr. drg. Maya Marinda Montain, M.kes</p>
      </div>
    </div>
  );
}
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col h-[507.359px] items-center left-[1190px] top-0 w-[289.5px]" data-name="Container">
      <ImageDrDrgMayaMarindaMontainMKes />
      <ParagraphMargin4 />
      <p className="[word-break:break-word] font-['__Karla_4e868f:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#3b9ca5] text-[14px] text-center w-[290px]">Direktur Perencanaan dan Pengembangan Strategi Layanan</p>
    </div>
  );
}

function ImageDrHaruddinSStMKesQrmaQhia() {
  return (
    <div className="h-[409.359px] relative rounded-[10px] shrink-0 w-[289.5px]" data-name="Image (Dr. Haruddin S. ST, M.Kes, QRMA, QHIA)">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgImageDrHaruddinSStMKesQrmaQhia} />
    </div>
  );
}
...
function ParagraphMargin5() {
  return (
    <div className="relative shrink-0" data-name="Paragraph:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[8px] relative size-full">
        <p className="[word-break:break-word] font-['__Karla_4e868f:Semi_Bold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#3b9ca5] text-[16px] text-center whitespace-nowrap">Dr. Haruddin S. ST, M.Kes, QRMA, QHIA</p>
      </div>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="absolute content-stretch flex flex-col h-[507.359px] items-center left-[1487.5px] top-0 w-[289.5px]" data-name="Container">
      <ImageDrHaruddinSStMKesQrmaQhia />
      <ParagraphMargin5 />
      <p className="[word-break:break-word] font-['__Karla_4e868f:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#3b9ca5] text-[14px] text-center whitespace-nowrap">Direktur Layanan Operasional</p>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="h-[507.359px] relative shrink-0 w-[1777px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container24 />
        <Container25 />
        <Container26 />
...
function Container22() {
  return (
    <div className="bg-white relative shrink-0 w-[1905px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[64px] py-[32px] relative size-full">
        <Container23 />
      </div>
    </div>
  );
...
function Container8() {
  return (
    <div className="h-[677.359px] relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container9 />
        <Container22 />
      </div>
